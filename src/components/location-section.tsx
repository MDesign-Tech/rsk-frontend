...
export function LocationSection({
  ...
  return (
     <motion.div
       ...
       className="mt-10"
     >
       <div className="rounded-2xl border border-border/70 bg-card/70 p-3 shadow-[0_20px_80px_rgba(15,23,42,0.08)] backdrop-blur sm:p-4 lg:p-6">
         ...
         <div className="overflow-hidden rounded-xl border border-border/60 bg-muted/30 shadow-[0_20px_60px_rgba(15,23,42,0.12)]">
           <iframe
             src={embedUrl}
             title="RSK Associates office location on Google Maps"
             aria-label="Google Maps showing the location of RSK Associates"
             className="min-h-[300px] sm:min-h-[400px] w-full border-0"
             loading="lazy"
