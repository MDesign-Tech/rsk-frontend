  ...
  return (
    <section id="features" className="relative py-12 sm:py-20 overflow-hidden">
      ...
      <div className="relative">
        <div className="absolute left-0 top-0 bottom-0 w-8 sm:w-32 bg-linear-to-r from-background to-transparent z-10 pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-8 sm:w-32 bg-linear-to-l from-background to-transparent z-10 pointer-events-none" />
