...
export function HomeContactUs() {
  ...
  return (
     ...
     >
       <div className="absolute inset-x-0 top-0 h-32 sm:h-48 bg-linear-to-b from-sky-950/20 to-transparent" />
           ...
           {contactMethods.map((item, index) => {
             ...
             return (
               <motion.div
                 ...
                 className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur-xl shadow-[0_20px_40px_-24px_rgba(14,116,232,0.65)]"
               >
