...
const testimonials = [
  ...
  {
    quote:
      "Finally, 24/7 support without the 24/7 staffing costs. RSK Associates pays for itself within the first month.",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-muted-foreground">
            Join thousands of teams already using RSK Associates
          </p>
        </motion.div>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <img
                  src={
                    testimonial.avatar || "/professional-woman-headshot-2.png"
                  }
                  alt=""
                  aria-hidden="true"
