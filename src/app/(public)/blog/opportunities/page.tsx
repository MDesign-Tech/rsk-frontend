  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden pt-28 pb-20">
        <div className="absolute inset-0 bg-linear-to-br from-slate-950/80 via-sky-950/10 to-transparent" />
        <div className="relative mx-auto max-w-6xl px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="mt-4 text-4xl sm:text-5xl font-bold">
              Find jobs, internships, tenders, and training with RSK.
            </h1>
            <p className="mt-6 max-w-3xl text-lg leading-8 text-muted-foreground">
              Discover curated opportunities designed for professionals and
              businesses ready to grow, learn, and partner with industry
              leaders.
            </p>
          </motion.div>
        </div>
